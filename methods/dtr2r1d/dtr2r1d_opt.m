...
opt.dtr2r1d = msf_ensure_field(opt.dtr2r1d, 'r2min', 0.1);
opt.dtr2r1d = msf_ensure_field(opt.dtr2r1d, 'r2max', 40);
opt.dtr2r1d = msf_ensure_field(opt.dtr2r1d, 'r1min', 0.1);
opt.dtr2r1d = msf_ensure_field(opt.dtr2r1d, 'r1max', 2);
opt.dtr2r1d = msf_ensure_field(opt.dtr2r1d, 'n_in', 3e2); % number of nodes in NNLS inversion. [100 - 1000]
...
opt.dtr2r1d = msf_ensure_field(opt.dtr2r1d, 'n_proliferation', 40); % number of initial iterations
opt.dtr2r1d = msf_ensure_field(opt.dtr2r1d, 'n_extinction', 40); % number of mutation rounds
...
opt.dtr2r1d = msf_ensure_field(opt.dtr2r1d, 't1_weighting', 'saturation'); % 'spin_echo', 'saturation'
